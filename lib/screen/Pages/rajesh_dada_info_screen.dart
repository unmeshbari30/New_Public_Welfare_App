...
//     appBar: AppBar(
//       centerTitle: true,
//       title: const Text("आपले राजेश दादा"),
//       backgroundColor: Colors.amber,
//     ),
//     body: SafeArea(
...
//             // While loading show shimmer for image and text box
...
//           final base64String = model.mlaInfo?.base64Data;

//           // try {
//           //   final base64Data = model.mlaInfo?.base64Data ?? "";
...
//                             fontWeight: FontWeight.bold,
//                             fontSize: 15,
//                             height: 1.5, // adds line spacing between lines inside paragraphs
//                           ),
//                         ),
...
//   return text
//       .split("\n")
//       .map((paragraph) => "$indent$paragraph")
//       .join("\n");
// }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () async {
            ref.refresh(rajeshInfoControllerProvider);
                ...
                return SingleChildScrollView(
                  ...
                  child: SizedBox(
                    height:
                        ...
                        0.8, // Ensure enough height for pull-to-refresh
                    child: const Center(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(
                              ...
                              fontSize: 15,
                              height:
                                  1.5, // adds line spacing between lines inside paragraphs
                            ),
                          ),
                        ),
                      ),
          ...
          child: RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: const Center(
                  child: Text("Something Went Wrong. Pull down to refresh."),
                ),
              ),
            ),
          ),
